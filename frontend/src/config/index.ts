...
import { customSomniaTestnet, customElectroneumTestnet, customBaseMainnet, customBaseSepolia } from './chains'
...
export const CONTRACT_ADDRESSES = {
  ...
  BASE_SEPOLIA: process.env.NEXT_PUBLIC_BASE_SEPOLIA_CONTRACT_ADDRESS,
